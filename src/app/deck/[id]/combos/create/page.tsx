...
export default function CreateDeckComboPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`/api/user/decks/${deckId}/combos`, {
        method: 'POST',
        headers: {
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-8 lg:pr-[380px]">
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold">Create Custom Combo</h1>
          <p className="text-muted-foreground mt-1">
            {currentDeck ? `Add a combo for ${currentDeck.name}` : 'Define a combo for this deck'}
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter a name, select the cards involved, and describe how it works
            </CardDescription>
          </CardHeader>
          <CardContent>
